...
/**
 * @author hendrawd
 * @see <a href="https://www.hackerrank.com/contests/projecteuler/challenges/euler089">https://www.hackerrank.com/contests/projecteuler/challenges/euler089</a>
 * @since 3/7/16
 */

public class ProjectEuler_89_RomanNumerals {
    private BufferedReader br;
    private PrintWriter out;
    private StringTokenizer st;

    public static void main(String[] args) throws IOException {
        new ProjectEuler_89_RomanNumerals();
    }
    ...
    private void solve() throws IOException {
        ...
        while (t-- > 0) {
            ...
            for (int i = 0; i < line.length(); i++) {
                adder += new RomanNumeral(line.charAt(i) + "").toInt();
            }
            out.println(new RomanNumeral(adder).toString());
        }
    }

    public ProjectEuler_89_RomanNumerals() throws IOException {
